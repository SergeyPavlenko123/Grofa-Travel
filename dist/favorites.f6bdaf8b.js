let u=JSON.parse(localStorage.getItem("favTours")),i=document.querySelector(".favorites-block");function a(){for(let a=0;a<u.length;a++)i.innerHTML+=`
        <div class="frame">
            <div class="favorites-item" style="background-image: url(./img/slider/${u[a].cover})">
                <div class="favorites-item-content">
                    <button class="close-button" id="${a}"></button>
                    <div class="content-heading">${u[a].title}</div>
                    <p class="item-text">${u[a].date}</p>
                    <p class="item-text">${u[a].price} \u{433}\u{440}\u{43D}</p>
                    <button class="button" id=${u[a].id}>
        ...
        `;0===u.length&&(i.innerHTML=`<div><h1>\u{417}\u{430}\u{440}\u{430}\u{437} \u{442}\u{443}\u{442} \u{43D}\u{456}\u{447}\u{43E}\u{433}\u{43E} \u{43D}\u{435}\u{43C}\u{430}\u{454}</h1></div>`)}i.addEventListener("click",function(l){if(l.target.matches(".close-button")){let s=l.target.id;u.splice(s,1),localStorage.setItem("favTours",JSON.stringify(u)),i.innerHTML="",0===u.length&&(i.innerHTML=`<div class="favorite-heading"><h1>\u{417}\u{430}\u{440}\u{430}\u{437} \u{442}\u{443}\u{442} \u{43D}\u{456}\u{447}\u{43E}\u{433}\u{43E} \u{43D}\u{435}\u{43C}\u{430}\u{454}</h1></div>`),a()}}),i.addEventListener("click",function(i){if(i.target.matches(".button"))var a=u.find(u=>u.id=u);document.querySelector("body").innerHTML=`
        <header class="header" style="background-image:url(./img/slider/${a.cover})">
        <div class="nav-bar">
          <div class="logo">
            <a href="../index.html">
        ...
        <div class="header-title">
          <div class="title-name">${a.title}</div>
      ...
      <main class="main">
        <div class="container">
          <div class="heading">
              ...
              <div class="heading-title">${a.title}</div>
            </div>
    ...
    `}),a();
//# sourceMappingURL=favorites.f6bdaf8b.js.map
