let u=document.querySelectorAll(".tour-button");AOS.init(),fetch("https://run.mocky.io/v3/7ae64052-c659-4c35-b6af-f46601a202a5").then(function(u){return u.json()}).then(function(a){u.forEach(u=>{u.addEventListener("click",function(u){document.querySelector("body").innerHTML=`
        <header class="header" style="background-image:url(./img/slider/${a[u.target.id].cover})">
        <div class="nav-bar">
          <div class="logo">
            <a href="../index.html">
        ...
        <div class="header-title">
          <div class="title-name">${a[u.target.id].title}</div>
      ...
      <main class="main">
        <div class="container">
          <div class="heading">
              ...
              <div class="heading-title">${a[u.target.id].title}</div>
            </div>
          <div class="description" data-aos="flip-left">
            <div class="content">
              <p class="text">
               ${a[u.target.id].description}
              </p>
            </div>
            <div class="poster">
      ...
      <footer class="footer">
        ...
        `})})});
//# sourceMappingURL=tours.97e83659.js.map
